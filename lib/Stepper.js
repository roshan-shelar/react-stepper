...
function Stepper(_ref) {
  var activeStep = _ref.activeStep,
      ...
      skipColor = _ref.skipColor,
      skipTitleColor = _ref.skipTitleColor,
      skipOpacity = _ref.skipOpacity,
      skipTitleOpacity = _ref.skipTitleOpacity,
      skipBarColor = _ref.skipBarColor,
      skipBorderColor = _ref.skipBorderColor,
      skipBorderStyle = _ref.skipBorderStyle;
